...
exports.DebugArgs = exports.NodeDebugAdapter = exports.ProcessEvent = void 0;
...
class ProcessEvent extends vscode_debugadapter_1.Event {
    constructor(name, systemProcessId) {
        super('process');
        this.body = {
            name,
            systemProcessId
...
let NodeDebugAdapter = /** @class */ (() => {
    class NodeDebugAdapter extends vscode_chrome_debug_core_1.ChromeDebugAdapter {
        constructor() {
            super(...arguments);
            this._jsDeterminant = new utils.JavaScriptDeterminant();
        ...
        sendInitializedEvent() {
            const _super = Object.create(null, {
                sendInitializedEvent: { get: () => super.sendInitializedEvent }
            });
            return __awaiter(this, void 0, void 0, function* () {
        ...
        configurationDone() {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield this._breakpoints.breakpointsQueueDrained;
        ...
        killNodeProcess() {
            if (this.nodeProcessId && !this.normalAttachMode) {
                if (this.nodeProcessId === 1) {
                    ...
                    vscode_chrome_debug_core_1.logger.log('Killing process with id: ' + this.nodeProcessId);
        ...
        terminate(args) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!this._attachMode && !this._launchAttachArgs.useWSL && this.nodeProcessId > 0) {
                    ...
                    try {
                        ...
                        if (e.message === 'kill ESRCH') {
                            vscode_chrome_debug_core_1.logger.log(`Got 'kill ESRCH'. Sending SIGINT to ${this.nodeProcessId}`);
        ...
        terminateSession(reason, args) {
            const _super = Object.create(null, {
                terminateSession: { get: () => super.terminateSession }
            });
            return __awaiter(this, void 0, void 0, function* () {
        ...
        resolveProgramPath(programPath, sourceMaps) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.jsDeterminant.isJavaScript(programPath)) {
                    ...
                    const generatedPath = yield this.sourceMapTransformer.getGeneratedPathFromAuthoredPath(programPath);
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (response.exceptionDetails) {
                    ...
                    if (typeof pid !== 'number') {
                        vscode_chrome_debug_core_1.logger.log(`Node returned a pid of ${pid}. Will try again later.`);
                        return;
                    }
