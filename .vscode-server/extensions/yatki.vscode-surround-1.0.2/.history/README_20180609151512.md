...
1.  Each custom wrapper function will have it's own command `surround.with.customCommandName`, so you can assign shortcut to your most used wrapper functions.
