...
After you save the configuration, _Surround_ will create `surround.with.yourCommandName` command for your snippet.

### IMPORTANT NOTES:

1.  All command names and labels must be unique. If you do not provide a **unique** `commandName` or `label` your custom wrapper functions will override existing ones.
...
1.  Each custom wrapper function will have it's own command `surround.with.customCommandName`, so you can assign shortcuts to your most used wrapper functions.
