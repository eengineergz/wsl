...
1. Right-click the gist in the `Gists` view and select `Upload Files(s)`. This supports any file type, and therefore is the most general-purpose solution. Once the image is uploaded, you can then reference it from your swing using only its filename (e.g. `<img src="https://github.com/codespaces-contrib/codeswing/raw/master/myImage.png" />`), since the swing preview understands the context of the "surrounding gist".
